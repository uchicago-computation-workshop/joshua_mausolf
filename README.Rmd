...
<h2 class=pfblock-header> 
  <a href="`r paper_link`" class="btn-custom-color-bk">`r title`</a>
</h2>
...
<p class=footertext>Students in the Masters of Computational Social Science program are expected to attend and join the discussion by posting a comment on on the [issues page](`r issues_page`) of the [workshop's public repository on GitHub](https://github.com/uchicago-computation-workshop).</p>
